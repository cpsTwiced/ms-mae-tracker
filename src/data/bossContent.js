...
export const BOSS_CONTENT = [
  ...
  },
  {
    ...
    // tracked. Both difficulties enter at a flat Lv.280.
    id: 'maleficstar',
    name: 'Malefic Star',
    cadence: 'weekly',
  ...
  },
  {
    ...
    // gated by Authentic Force past that. Portrait is the community MapleStory
    // Wiki's `Mob Jupiter` sprite (maplestory.io has no post-v.268 data).
    id: 'jupiter',
    name: 'Jupiter',
    cadence: 'weekly',
    img: '/bosses/jupiter.png',
    difficulties: [
      { d: 'Normal', level: 295 },
      { d: 'Hard', level: 295 },
    ],
